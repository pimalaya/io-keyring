# I/O Keyring [![Documentation](https://img.shields.io/docsrs/io-keyring)](https://docs.rs/io-keyring/latest/io_keyring) [![Matrix](https://img.shields.io/matrix/pimalaya:matrix.org?color=success&label=chat)](https://matrix.to/#/#pimalaya:matrix.org)
